...
# run in firefox
# open all 3 relevant apps
firefox -new-tab -url /home/mezcel/github/scrapy-scrape-viewer/index.html -new-tab -url /home/mezcel/github/googlemaps-api-helloworld/index.html -new-tab -url /home/mezcel/github/document-generator/index.html &
exit
